...
#Forward-backward and right-left movement counters and arrays to be used
reset = 0
loop_check = 0
move_fb = 0
move_rl = 0
...
#Decision-making function to communicate with motor for moving the canopy
def optimize():
    global count_rl
...
while True:
    ...
    #Change of movement variables for operation
